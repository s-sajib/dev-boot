...
method. The getMessage method returns a string, and any type that implements the method can be
considered a message (meaning it implements the message interface).
...
Notice that your code doesn't care at all about whether a specific message is a birthdayMessage or a
sendingReport!
*/
...
func sendMessage(msg message) (string, int) {
	...
	cost := len(messageContent) * 3
	return messageContent, cost
}
