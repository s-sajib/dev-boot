...
func TestSliceOfSlice(t *testing.T) {
	fmt.Println("-----------------------------------------------------------------")
	fmt.Println("------------------- Slice of Slice Test Start ---------------------")
	fmt.Println("-----------------------------------------------------------------")
	...
	tests := []testCase{
		...
		{5, -5, [][]int{}},
		{2, 3, [][]int{{0, 0, 0}, {0, 1, 2}}},
		{3, 3, [][]int{{0, 0, 0}, {0, 1, 2}, {0, 2, 4}}},
		{4, 2, [][]int{{0, 0}, {0, 1}, {0, 2}, {0, 3}}},
		{3, 4, [][]int{{0, 0, 0, 0}, {0, 1, 2, 3}, {0, 2, 4, 6}}},
	}
	if withSubmit {
...
`,
	...
	fmt.Println("-----------------------------------------------------------------")
	fmt.Println("------------------- Slice of Slice Test End ---------------------")
	fmt.Println("-----------------------------------------------------------------")
}
